...
game9gdialog.innerHTML='<header><h2 id="game9gtitle">公众号@懒人码农</h2></header><section id="game9gcontent"></section><footer><a href="javascript:void(0)" id="game9gleftbtn">取消</a><a href="javascript:void(0)" id="game9grightbtn">确定</a></footer>';
...
var domains=["106.55.168.13:8099"];
var domain = domains[parseInt(Math.random() * domains.length)];
    if(window.shareData){
		window.shareData.timeLineLink = "http://"+ parseInt(Math.random()*100000) +"."+ myData.gameid +"."+domain+"/h5game?gameid=" + myData.gameid + (localStorage.myuid ? "&uid=" + localStorage.myuid : "");
